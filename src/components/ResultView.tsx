	...
	return (
		...
		>
			...
			<div>
				...
				<div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
					...
					{record.systemTags.length === 0 && record.userTags.length === 0 && (
						<span
							style={{ fontSize: 10, color: colors.text, fontStyle: "italic" }}
						>
							{t.noTags}
						</span>
					)}
							...
							return (
								<button
									...
									style={{
										...
										fontSize: 10,
										fontWeight: 600,
										backgroundColor: selected ? c.color + "30" : colors.bg,
										color: selected ? c.color : colors.text,
			...
			<div style={{ display: "flex", alignItems: "center", gap: 8 }}>
				...
				<button
					onClick={onDelete}
					style={{ ...iconBtnStyle(colors), color: colors.text }}
